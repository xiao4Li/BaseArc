            ...
            <div class="col-md-12" style="padding: 0;margin: 0">
                <div class="nav-tabs-custom " style="margin: 0;padding:0;" >
                    ...
                    <div class="tab-content" style="padding:0;margin:0;">
                        <div class="tab-pane base_tab_container active" id="tab_1">
                            <iframe src="http://www.baidu.com" width='100%' height='100%'  scrolling="auto" frameborder=0></iframe>
                        </div>
                        <div class="tab-pane base_tab_container " id="tab_2"  >
                            <iframe src="https://zhidao.baidu.com/question/234249913.html" width='100%' height='100%'  scrolling="yes" frameborder=0></iframe>
                        </div>
